...
(11, 'test', 'test', NULL, NULL, 'students,teacher', NULL, 1, 'published', '2025-05-05 01:00:52');
...
CREATE TABLE `articles` (
  ...
  `status` enum('PENDING','APPROVED','REJECTED','DELETED') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDING',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(47, 8, 'dadzcx', '', '', NULL, 1, 1, 'PENDING', '2025-05-05 05:53:57', NULL, '2025-05-05 13:53:57', 0, 0, NULL),
(48, 8, 'mpmp', '', '', NULL, 1, 1, 'PENDING', '2025-05-05 05:54:06', NULL, '2025-05-05 13:54:06', 0, 0, NULL);
...
(8, 'Student', 'Dona', 'eran@dbclm.com', '$2y$10$bwbsQ5gXmc28IAl67c1jeeadJk5TE.TXIqxrZ0RFfOKOzuNlYZ2eS', 'ITed', '2025-04-24 06:20:01', 'Screenshot 2025-04-07 111401.png'),
